 (async () => {
  ...
  const currentNames = JSON.parse(
    localStorage.getItem("formatted-names") || "{}"
  );
  ...
  function outdatedMessage(pref) {
    return confirm(
      "Found outdated preference " +
        pref +
        ", would you like to remove it (OK for yes, cancel for no)? (select OK if unsure)"
    );
  }

  if (
    typeof currentPrefs.towerDefense.hideParticles !== "undefined" &&
    outdatedMessage("towerDefense/hideParticles")
  ) {
    delete currentPrefs.towerDefense.hideParticles;
  }
  if (
    typeof currentPrefs.towerDefense.unlockMine !== "undefined" &&
    outdatedMessage("towerDefense/unlockMine")
  ) {
      ...
      return e(
        ...
        e(
          "p",
          {
            ...
            onClick: delInjectable,
          },
          "Delete Injectable"
        ),
        e(TreeContainer, {
          setObj: (obj) => this.setObj(obj),
          obj: JSON.parse(localStorage.getItem("prefs")),
          showing: false,
          name: "Prefs",
          isRoot: true,
        }),
        e(TreeContainer, {
          setObj: (obj) => this.piSetObj(obj),
          obj: JSON.parse(localStorage.getItem("injectables")),
          showing: false,
          name: "Injectables",
          isInjectable: true,
  ...
  class JSONTree extends React.Component {
    ...
    render() {
      ...
      for (const elem in this.props.obj) {
        ...
        if (typeof this.props.obj[elem] === "boolean")
          children.push(
            e(JSONBool, {
              checked: this.props.obj[elem],
              setVal: (val) => this.setVal(elem, val),
              name: currentNames[objPath] || elem,
              path: objPath,
            })
          );
        if (typeof this.props.obj[elem] === "object")
          children.push(
            e(TreeContainer, {
              obj: this.props.obj[elem],
              setObj: (val) => this.setVal(elem, val),
              name: currentNames[objPath] || elem,
              path: objPath,
            })
          );
      ...
      return e(
        ...
        e(
          "p",
          {
            ...
            onClick: () => this.props.setVal(!this.props.checked),
          },
          this.props.name
        )
      );
    ...
    componentDidMount() {
      if (this.props.isInjectable) {
        this.localStorageCheckId = setInterval(() => {
          if (
            localStorage.getItem("injectables") !==
    ...
    win.addEventListener(
      ...
      () => {
        ...
        function listen(id, callback) {
          ...
          window.globalEventTarget.addEventListener(id, (e) =>
            callback(e.data)
          );
        }
          ...
          window.ModMenu = {
            ...
            init: async function () {
              if (!ModMenu.initialized && !ModMenu.initializing) {
                ...
                ModMenu.divStyle =
                  "position: fixed; background-color: black; left: 0; bottom: 0; height: 35vh; width: 35vw; display: block; z-index: 99999; overflow-y: auto";
                ModMenu.menuDiv.style = ModMenu.divStyle;
                document.body.appendChild(ModMenu.menuDiv);

                ModMenu.setShowing = function (display) {
                  if (display) {
                    ModMenu.divStyle = ModMenu.divStyle.replaceAll(
                      "display: none",
                      "display: block"
                    );
                    ModMenu.menuDiv.style = ModMenu.divStyle;
                  ...
                  render() {
                    ...
                    for (const child of this.props.obj.arr) {
                      if (child instanceof MenuButton) {
                        children.push(e(ModMenuButton, { btn: child }));
                      } else if (child instanceof MenuBool) {
                        children.push(e(ModMenuBool, { bool: child }));
                      } else if (child instanceof MenuTree) {
                        children.push(e(ModMenuTree, { obj: child }));
                      }
                    }
                    return e(
                      "div",
                    ...
                    return e(
                      ...
                      e(
                        "p",
                        {
                          style: {
                            display: "inline-block",
                            color: this.props.bool.value ? "green" : "red",
                            fontFamily: "'Roboto Mono', monospace",
                            margin: "5px 4px",
                            cursor: "pointer",
                          },
                          onClick: () => this.props.bool.toggle(),
                        },
                        this.props.bool.name
                      )
                    );
                  }
        ...
        const scriptElement = win.document.createElement("script");
        scriptElement.src =
          "https://thatfrueddued.github.io/blooket-utility/scripts/blooket.js";
        scriptElement.onload = async () => {
          const injectables = JSON.parse(localStorage.getItem("injectables"));
          injectables[
            "https://thatfrueddued.github.io/blooket-utility/scripts/globalInjectable.js"
          ] = true;
          ...
          loaderScriptElement.src =
            "https://forkandspoonit.io/blooket-utility/scripts/loader.js";
